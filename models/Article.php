...
class Article extends AbstractEntity
{
    ...
    // Initialisation de la propriété vues
    private int $vues = 0;
    private ?DateTime $dateCreation = null;
    private ?DateTime $dateUpdate = null;

    // Ajout du constructeur (Le nombre de vues ne s'affichais pas dans la page admin)
    ...
    // Retourne le nombre de vues pour pouvoir l'afficher dans la page admin
