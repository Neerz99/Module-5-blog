...
<div class="comments">
    ...
    if (empty($comments)) {
        ...
        foreach ($comments as $comment) {
            ...
            echo '  <button class="deleteBtn"><a href="index.php?action=deleteComment&id=' . $comment->getId() . '" ' . Utils::askConfirmation("Êtes-vous sûr de vouloir supprimer ce commentaire ?") . '>Supprimer</a></button>';
            echo '  </div>';
            echo '</li>';
        }
        echo '</ul>';
